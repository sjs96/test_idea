...
public class ExcelUtil2 {
     ...
     * @param sheet
     */
    public ExcelUtil2(HSSFWorkbook wb, HSSFSheet sheet) {
        // super();  
        this.wb = wb;  
        this.sheet = sheet;  
    }  
    ...
    public static Map<String,Object> toExecl(String worksheetTitle,List<Map<String, Object>> valueList,List<Map<String, Object>> keyList ){
		...
		try {
		        ...
		        ExcelUtil2 exportExcel = new ExcelUtil2(wb, sheet);
...
*/	//设置第一行
	...
	// 创建报表头部  
	public static void setTitle(ExcelUtil2 exportExcel, String worksheetTitle, int length){
